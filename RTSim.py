...
def main():
    ...
    line, = amplitude_ax.plot([0, 100], sensor_config.range_interval)
    ...
    while not interrupt_handler.got_signal:
        ...
        amplitude_ax.plot(iter, dist, 'r+') #Plot time and data point
    ...
    amplitude_ax.clear()
    amplitude_ax.plot(tlist, length, 'r+', label='Noise', linewidth=0.2)
    amplitude_ax.set_title("Drone movement + Noise")
    fig.canvas.draw()

    #Turn off Autodisplay After Data Collection and Plotting
    plt.ioff()
